    ...
    return (
        <div className="centered">
            <div className="shadow-xl p-8" style={{ width: "300px" }}>
                ...
                <div className="poppins flex justify-center text-2xl my-8 mb-0 font-bold">
                    <span>M E D I C W I S E</span>
                </div>
                <div className="poppins flex justify-end mr-8 mb-4">
                    <span style={{ fontSize: "13px" }}>Admin Portal</span>
                </div>
                <form className="max-w-sm" onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center justify-between">
                        <button
                            disabled={loading}
                            className="bg-gray-500 hover:bg-gray-700 text-white font-bold w-full h-12 py-2 px-4  rounded focus:outline-none focus:shadow-outline signUp-font"
                            type="submit"
                        >
                            Log In
                        </button>
